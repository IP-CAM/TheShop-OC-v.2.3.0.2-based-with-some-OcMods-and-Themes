    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
		  ...
		  <div class="form-group">
			  <label class="col-sm-2 control-label" for="blog-image"><?php echo $entry_image; ?></label>
			  <div class="col-sm-10">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="article_description[<?php echo $language['language_id']; ?>][intro_text]" placeholder="<?php echo $entry_intro_text; ?>" id="input-intro-text<?php echo $language['language_id']; ?>"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['intro_text'] : ''; ?></textarea>
                        </div>
                  </div>
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" name="article_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
...
<?php foreach ($languages as $language) { ?>
          ...
          $('#input-intro-text<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>

...
<div class="pull-left">
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-language" class="form-language">
  <div class="btn-group">
    ...
    <?php foreach ($languages as $language) { ?>
      <?php if ($language['code'] == $code) { ?>
        <span class=""><?php echo $language['name']; ?></span> <i class="fa fa-angle-down"></i></button>
      <?php } ?>
    <?php } ?>

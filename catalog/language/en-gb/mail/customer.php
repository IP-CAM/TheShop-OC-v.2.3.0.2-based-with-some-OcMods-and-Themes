...
$_['text_welcome']        = 'ВІтаємо і дякуємо за реєстрацію на %s!';
$_['text_login']          = 'Ваш обліковий запис створено і ви можете увійти через наш сайт використовуючи ваш e-mail і пароль або по цьому посиланню:';
